...
get '/calendarios' do
  begin
    ...
    halt 200, conversor_json.obtener_array_json_calendarios(calendarios).to_json
  rescue Exception => ex
    halt 400, '400 Bad Request: ' + ex.to_s
  end
end
...
get '/calendarios/:nombre' do
  begin
    ...
    halt 200, conversor_json.obtener_json_calendario(calendario).to_json
  rescue Exception => ex
...
get '/eventos' do
  begin
    ...
    halt 200, conversor_json.obtener_array_json_eventos(eventos).to_json
  rescue Exception => ex
    halt 400, '400 Bad Request: ' + ex.to_s
  end
end
...
get '/eventos/:id' do
  begin
    ...
    halt 200, conversor_json.obtener_array_json_eventos(evento).to_json
  rescue Exception => ex
    halt 400, '400 Bad Request: ' + ex.to_s
  end
end